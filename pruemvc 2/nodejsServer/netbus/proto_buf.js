...
var proto_buf = {}
proto_buf.decode_cmd = decode_cmd;
proto_buf.encode_cmd = encode_cmd;
proto_buf.encrypt_cmd = encrypt_cmd;
proto_buf.decrypt_cmd = decrypt_cmd;


module.exports = proto_buf;